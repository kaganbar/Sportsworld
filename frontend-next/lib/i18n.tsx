...
const translations = {
  en: {
    ...
    heroTagline: "The world of sport, in one place.",
    heroScroll: "Scroll",
    heroEnter: "Enter",
    sportWorldTitle: "Explore by country",
    sportWorldSubtitle: "Spin the globe or tap a country to jump into its leagues.",
    sportWorldHint: "Pick a country to see its leagues.",
  ...
  he: {
    ...
    heroTagline: "עולם הספורט, במקום אחד.",
    heroScroll: "גלול",
    heroEnter: "כניסה",
    sportWorldTitle: "לפי מדינה",
    sportWorldSubtitle: "סובבו את הגלובוס או הקישו על מדינה כדי לצלול לליגות שלה.",
    sportWorldHint: "בחרו מדינה כדי לראות את הליגות שלה.",
