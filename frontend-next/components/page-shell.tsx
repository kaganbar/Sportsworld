...
// The canonical dark/glass page wrapper for every page NOT wrapped in
// ThemeLayout (which has its own per-sport gradient + 3D canvas + scrim).
...
// 3D backgrounds — that pattern must not change here).
export default function PageShell({
  ...
  return (
    <div
      className={cn("dark relative z-0 min-h-screen bg-galaxy-shell pb-16 text-white", className)}
