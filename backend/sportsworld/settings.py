...
WSGI_APPLICATION = "sportsworld.wsgi.application"

DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": os.environ.get("POSTGRES_DB", "sportsworld"),
        "USER": os.environ.get("POSTGRES_USER", "sportsworld"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "sportsworld"),
...
# Vite dev server origin — dev-only, tighten before any production deploy.
